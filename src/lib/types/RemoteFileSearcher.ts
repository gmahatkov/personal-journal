...
export interface IRemoteFileSearcher<SearchParams extends Record<string, any>> {
...
> {
	...
	): ProviderName extends RemoteFileProviderRequireImageAsBufferNames
		? IRemoteFileSearcher<SearchParams> & IRemoteFileSearcherImageAsBuffer
		: IRemoteFileSearcher<SearchParams>;
}

export abstract class RemoteFileSearcher<SearchParams extends Record<string, string>>
	implements IRemoteFileSearcher<SearchParams>
{
...
export type RemoteFileProviderName =
