...
<AppAuth>
	...
	<SignIn provider="resend" className="sign-in-credentials">
		<input
			slot="email"
			type="email"
			id="email"
			...
			placeholder="Email"
		/>
		<div slot="submitButton" class="sign-in-credentials_submit-button">
			<UserSolid />
		</div>
	</SignIn>
	<SignIn provider="google-drive" className="sign-in-oauth">
		<div slot="submitButton" class="sign-in-oauth_submit-button">
